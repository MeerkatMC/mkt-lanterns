...
system.beforeEvents.startup.subscribe(({ blockComponentRegistry }) => {
  blockComponentRegistry.registerCustomComponent(LIGHT_CONTROL_COMPONENT, BlockSimpleLightOnOffToggle);
});
